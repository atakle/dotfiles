...
if has("gui_running")
    ...
    hi SpecialKey      guibg=#141414 guifg=#E783E9 gui=none
    ...
    hi SpecialComment guibg=#1F1F1F guifg=#696567 gui=none
    hi Tabstop        guibg=#1F1F1F guifg=#696567 gui=none
    ...
    hi MatchParen     guibg=#1F1F1F guifg=#FFA500 gui=none
...
elseif &t_Co == 256
    ...
    hi Tabstop        ctermbg=234  ctermfg=241   cterm=none
    ...
    hi MatchParen     ctermbg=234  ctermfg=214   cterm=underline
...
elseif &t_Co == 16
    ...
    hi SpecialKey      ctermbg=7  ctermfg=5  cterm=none
    ...
    hi Tabstop        ctermbg=8  ctermfg=7  cterm=none
    ...
    hi MatchParen     ctermbg=8  ctermfg=14 cterm=underline
...
" hi MatchParen     ctermbg=6  ctermfg=8  cterm=none
    hi MatchParen     ctermbg=8  ctermfg=6  cterm=underline
    hi PreProc        ctermbg=8  ctermfg=5  cterm=none
...
if has("spell")
    if &t_Co == 8
        ...
        hi SpellCap   term=standout ctermfg=7 ctermbg=4
        hi SpellLocal ctermfg=0     ctermbg=6
        hi SpellRare  ctermfg=0     ctermbg=5
    else
        hi SpellBad   ctermfg=0 ctermbg=9  guisp=#FC4234 gui=undercurl
        hi SpellCap   ctermfg=0 ctermbg=12 guisp=#70BDF1 gui=undercurl
        hi SpellLocal ctermfg=0 ctermbg=14 guisp=#FFEE68 gui=undercurl
        hi SpellRare  ctermfg=0 ctermbg=13 guisp=#6DF584 gui=undercurl
    endif
endif
